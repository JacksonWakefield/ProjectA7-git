<%@ Page Title="Contact" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="ProjectA7.Contact" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <section class="row" aria-labelledby="aspnetTitle">
        <h1 id="aspnetTitle">Staff Login</h1>
    </section>
    <div class="row">
