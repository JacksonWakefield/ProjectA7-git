    ...
    public partial class Contact : Page
    {
        ...
        protected void LoginClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (StreamReader reader = new StreamReader(HttpRuntime.AppDomainAppPath + "/App_Data/AdminInfo.txt"))
                {
                    //csv labels
            ...
            if (output.Contains("SUCCESS"))
            {
                ...
                meta.Content = "3;url=http://webstrar86.fulton.asu.edu/page1/Staff";
                this.Page.Controls.Add(meta);

                confirmationText.Text = output + " --- you will be redirected to your Staff page in 3 seconds...";
            }
            else
            {
